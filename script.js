const story1Sections = [
    ...
    },
    {
        ...
        image: "images/section3.jpg",  // Path to image
        errors: ["karautti", "kiittäen", "liikutuksen", "kieltäytyi", "liikuttunut"],
        quiz: [
...
document.addEventListener("DOMContentLoaded", function () {
    loadProgress();
    updateAchievements(); // Initial check
